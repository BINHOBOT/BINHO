...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Binho\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5574988746593:+55 7498874-6593\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD BINHO BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de Binho. Registre-se para fazer amizade com o bot Binho por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar binho|14\n\n──「 Binho BOT 」──`,
			...
			const ownerNumber = ["5574988746593@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5574988746593@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5574988746593@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5574988746593@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5574988746593@s.whatsapp.net","5511911120895@s.whatsapp.net","5577999189773@s.whatsapp.net","5514998487102@s.whatsapp.net","5549999156302@s.whatsapp.net","5527997502230@s.whatsapp.net","5511960327021@s.whatsapp.net","557598387137@s.whatsapp.net","5527999480647@s.whatsapp.net"]
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("5 segundos, tchau racista do krlh😤✋")
		}, 0)
	}
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("5 segundo flw mn, até nunca mais ksksks")
		}, 0)
	}
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("5 segundo KKKKKKKK tchau otário, pegue esse link e enfie no deu toba 🤬")
		}, 0)
	}
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("5 segundo KKKKKKKK tchau pague esse link e enfie no seu toba 😤👌🏻")
		}, 0)
	}
	...
	if (messagesC.includes("bosta")){
		...
		if (messagesC.includes("corno")){
			client.updatePresence(from, Presence.composing)
			reply("sou mesmo, sua mãe me trocou pelo o kid bengala 😔")
	}
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO BINHO BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @binho domina vida
          ...
          reply('Espere..')
			    ...
			    case 'dono':
                    ...
                    client.sendMessage(from, 'Meu dono é esse gasoso aí tal de "BINHO"🙄🔥, chama ele aí ele diz que é "Shitpost"',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT BINHO ✨* 」\n*│+ wa.me/5574988746593*╰──────*「 *BINHO* 」*────*\n\n*_SE QUER SER ADMIN DO BOT BINHO_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do binho:*\n\n https://youtube.com/channel/UCXox1JULpGZN9phG78BFtUw'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
				...
				case 'boanoite':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'boa noite o krlh vsfdr ❤️'})
					break
				case 'bomdia':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/gallery/zFvzl2S`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'bom dia o krlh vtmnc🙄🖕'})
					break
				case 'termux':
					meme = await kagApi.memes()
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* BINHO\n*YOUTUBE:* https://youtube.com/channel/UCXox1JULpGZN9phG78BFtUw\n*WPP:* wa.me/+5574988746593\n*\n\nEspero que tenham gostado do bot️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
        ...
        case 'promover':
				...
				case 'bemvindo':
					...
					if (Number(args[0]) === 1) {
						...
						reply('1 para ativar, 0 para desativar, lerdão vc em pqp KAKKKK')
					}
                                      break
				case 'clonar':
					if (!isGroup) return reply(mess.only.group)
